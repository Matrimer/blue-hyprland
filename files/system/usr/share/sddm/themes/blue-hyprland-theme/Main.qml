...
Rectangle {
  ...
  property color background   : config.background   ? config.background   : "#303F9F"
  ...
  property color topBar       : config.topBar       ? config.topBar       : "#282828"
  property color bottomBar    : config.bottomBar    ? config.bottomBar    : "#282828"

  property color inputField   : config.inputField   ? config.inputField   : "#5965B2"
  ...
  property color accentFocus  : config.accentFocus  ? config.accentFocus  : "#FF80AB"
  ...
  Rectangle {
    ...
    Row {
      ...
      LayoutBox {
        ...
        focusColor  : accentFocus
        hoverColor  : accentHover
        textColor   : normalText
        menuColor   : inputField
      ...
      ComboBox {
        ...
        color       : inputField
        borderColor : inputField
        focusColor  : accentFocus
        hoverColor  : accentFocus
        textColor   : normalText
        menuColor   : inputField
